...
**当前公网已恢复并验收：** https://uvyxrpacfugt.sealoshzh.site/ 。2026-09-17 09:42:47 启动，预计北京时间 **15:42:47** 停止，之后自动回收。备份恢复成功，原 paid/unpaid 交付会话均验证通过；重新创建测评、非法输入/跨站拦截、免费 DTO、并发模拟支付与完整结果的公网自动断言通过，Edge 浏览器完整报告已显示。下文 9 月 15 日记录为首次验收历史。
